...
describe.each([
    ...
    it.only('tuple__', async function () {
        // resp = await instance.call('(return# (tuple__ 100 4) )');
        ...
        // resp = await instance.call('(return# (tuple__ 100 4 "0x112233445566" "hello" 5) )');
        ...
        resp = await instance.call('(return# (tuple__ 100 4 (tuple__ "0x112233445566" "hello" 5)) )');
        expect(resp).toBe('');
    });
