...
describe.each([
    ...
    it('tuple___ simple', async function () {
        resp = await instance.call('(return# (tuple___ 100 4) )');
    ...
    it('tuple___ with bytes', async function () {
        resp = await instance.call('(return# (tuple___ 100 4 "0x112233445566" "hello" 5) )');
    ...
    it('tuple___ with tuple', async function () {
        resp = await instance.call('(return# (tuple___ 100 4 (tuple___ "0x112233445566" "hello" 5) 16) )');
    ...
    it('get_tn__', async function () {
        resp = await instance.call(`(return# (get_tn__
    ...
    // it('tuple_from_t2___', async function () {
    //     const t2data = '';
    //     resp = await instance.call(`(return# (tuple_from_t2___ "${t2data}") )`);
    //     expect(resp).toBe(t2data);
    // });
