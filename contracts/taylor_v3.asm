...
// expects t3 pointer on stack ; 0 = index
    ...
    eval_native_function:
        ...
        jump
    eval_native_function_post:
        /* (10) getframe // result_ptr, frame_ptr   // result_ptr, frame_ptr   */
0xe0
            mload
...
for_stack_4:
    ...
    forloop_end_stack_4:
        ...
        setfn_10_extra:  // pointer to lambda - length & lambda
            ...
            0x3100004200000000000000000000000000000000000000000000000000000000
            /* (0) getfncounter //   //   */
0x01
            sload
            add
...
// expects length; 0 = freeMemPtr
    ...
    mstore     // ptr
        ...
        clone__21_extra:
            // size, source_ptr_
            dup2
            /* (8) t2_init__ 0x40      // size, source_ptr_, target_ptr__   // size, source_ptr_, target_ptr__   */
// expects length; 0 = freeMemPtr
    dup1
    0x20
    add           // length, fulllength
    ...
    mstore     // ptr
            ...
            swap2
            swap1        // target_ptr__, size, source_ptr_
            dup3
            /* (15) t2_ptr_ // target_ptr__, size, source_ptr_, target_ptr_   // target_ptr__, size, source_ptr_, target_ptr_   */
// expects t2 pointer
    0x20
    add
            /* (1) mmultimstore // target_ptr__   // target_ptr__   */
// alloc before using it
            // size_bytes, source_ptr, target_ptr
            dup3   // size_bytes
...
0x140
        ...
        create_21_extra:
            // t2__, value
            dup2
            /* (6) t2_len_ // t2__, value, len   // t2__, value, len   */
// expects t2 pointer
    mload
...
// expects a 4byte value
        ...
        join__x1_extra:
            ...
            swap1     // t2_1, t2_2
            dup2      // t2_1, t2_2, t2_1
            /* (8) t2_len_ // t2_1, t2_2, t2_len   // t2_1, t2_2, t2_len   */
// expects t2 pointer
    mload
            dup2      //
            /* (9) t2_len_ // t2_1, t2_2, t2_1_len, t2_2_len   // t2_1, t2_2, t2_1_len, t2_2_len   */
// expects t2 pointer
    mload
            dup2
            dup2
            ...
            /* (9) t2_init__ 0x40  // t2_1, t2_2, t2_1_len, t2_2_len, t2_3__   // t2_1, t2_2, t2_1_len, t2_2_len, t2_3__   */
// expects length; 0 = freeMemPtr
    dup1
    0x20
    add           // length, fulllength
...
// expects t2 pointer
    0x20
    add
            /* (2) mmultimstore // size_bytes, source_ptr, target_ptr // t2_1, t2_2, t2_3__, t2_2_len, t2_1_len   // size_bytes, source_ptr, target_ptr // t2_1, t2_2, t2_3__, t2_2_len, t2_1_len   */
// alloc before using it
            // size_bytes, source_ptr, target_ptr
            dup3   // size_bytes
...
for_stack_10:
        ...
        pop
        jump
    forloop_stack_10:   // any content variables are kept after jumptag, end, step
...
// expects t2 pointer
    ...
    add
            dup4
            add       // t2_1, t2_2, t2_3__, t2_2_len, t2_1_len, t2_2_len, t2_2_ptr, t2_3__ptr
            /* (3) mmultimstore // t2_1, t2_2, t2_3__, t2_2_len, t2_1_len   // t2_1, t2_2, t2_3__, t2_2_len, t2_1_len   */
// alloc before using it
            // size_bytes, source_ptr, target_ptr
            dup3   // size_bytes
...
for_stack_11:
        ...
        pop
        jump
    forloop_stack_11:   // any content variables are kept after jumptag, end, step
...
// expects a 4byte value
            ...
            dup1
            /* (2) t3_init__ 0x40  // args, arity, ptr   // args, arity, ptr   */
// expects on stack: arity
    dup1   // arity
    0x20
    mul
    ...
    dup2     // ptr, arity, ptr
    mstore   // store arity at pointer -> ptr
            dup1            // args, arity, ptr, ptr
            0x20
            add             // args, arity, ptr, current_ptr
            swap1           // args, arity, current_ptr, ptr
            swap2           // args, ptr, current_ptr, arity
...
for_stack_12:
    ...
    forloop_stack_12:   // any content variables are kept after jumptag, end, step
                ...
                // args, ptr, current_ptr, tag, end, start
                dup6        // args, ptr, current_ptr, tag, end, start, arg
                dup5        // args, ptr, current_ptr, tag, end, start, arg, current_ptr
                mstore      // args, ptr, current_ptr, tag, end, start
                dup4        // args, ptr, current_ptr, tag, end, start, current_ptr
                0x20
                add
                swap4
                pop         // args, ptr, current_ptr, tag, end, start
                swap1
                swap2
                swap3
                swap4
...
mload   // expects t3 pointer on stack
            ...
            dup1
            /* (3) t3_init__ 0x40      // t3ptr___, new_arity, new_t3___   // t3ptr___, new_arity, new_t3___   */
// expects on stack: arity
    dup1   // arity
    0x20
    mul
    ...
    mstore   // store arity at pointer -> ptr
            ...
            dup2
            0x20
            mul                 // t3ptr___, new_arity, new_t3___, size_bytes
            dup4
            0x40
            add                 // t3ptr___, new_arity, new_t3___, size_bytes, source_ptr
            dup3
            0x20
            add                 // t3ptr___, new_arity, new_t3___, size_bytes, source_ptr, target_ptr
            /* (4) mmultimstore // t3ptr___, new_arity, new_t3___   // t3ptr___, new_arity, new_t3___   */
// alloc before using it
            // size_bytes, source_ptr, target_ptr
            dup3   // size_bytes
...
mload   // expects t3 pointer on stack
            dup2
            /* (2) t3_arity_ // t3ptr___1, t3ptr___2, arity1, arity2   // t3ptr___1, t3ptr___2, arity1, arity2   */
mload   // expects t3 pointer on stack
            dup2
            dup2
...
// expects on stack: arity
    ...
    mstore   // store arity at pointer -> ptr
            ...
            dup3
            0x20
            mul                  // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1

            dup1                 // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1, size_bytes1
            dup7
            0x20
            add                  // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1, size_bytes1, t3ptr___1_ptr
            dup4
            0x20
            add                  // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1, size_bytes1, t3ptr___1_ptr, new_t3____ptr
            /* (5) mmultimstore // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1   // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1   */
// alloc before using it
            // size_bytes, source_ptr, target_ptr
            dup3   // size_bytes
...
for_stack_14:
    ...
    forloop_end_stack_14:
        ...
        mmultimstore_end_5:
            ...
            dup3
            0x20
            mul                  // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1, size_bytes2
            dup6
            0x20
            add                  // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1, size_bytes2, t3ptr___2_ptr
            dup4
            0x20
            add                   // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1, size_bytes2, t3ptr___2_ptr, new_t3___ptr
            dup4
            add
            /* (6) mmultimstore // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1   // t3ptr___1, t3ptr___2, arity1, arity2, new_t3___, size_bytes1   */
// alloc before using it
            // size_bytes, source_ptr, target_ptr
            dup3   // size_bytes
...
for_stack_15:
        ...
        pop
        jump
    forloop_stack_15:   // any content variables are kept after jumptag, end, step
...
0xa0
            add
            mload
            mload           // t3___ptr, lambda_ptr, result_ptr, output_ptr
            0x01
            /* (0) t3_setitem // t3___ptr, lambda_ptr   // t3___ptr, lambda_ptr   */
...
// expects t3 pointer on stack ; 0 = index
    ...
    add
    mload
            dup2      // arg_ptr, lambda_ptr, arg, lambda_ptr
            apply_xx_extra        // lambda_ptr can be signature_ptr for compiled fn
            jump
...
// expects t3 pointer, index on stack
    ...
    mload
            ...
            /* (1) t3_setitem // arg_ptr, lambda_ptr   // arg_ptr, lambda_ptr   */
// expects result, t3 pointer, index on stack
    0x20
    mul
    0x20
    ...
    mstore
            ...
            dup2    // arg_ptr, lambda_ptr, arg_ptr
            mload   // arg_ptr, lambda_ptr, arity

            0xe0
            mload
            0xc0
            add
            mload   // arg_ptr, lambda_ptr, arity, step
            lt
            map_xx_extra_loop_
            jumpi
...
0x140
        ...
        map_xx_extra_loop_:
            ...
            mload
            0xc0
            add     // step, step incr, ptr
            mstore   // arg_ptr, lambda_ptr, step
...
// expects a pointer
            ...
            0xe0
            shr
            /* (0) getfunctype // args, ptr__, ftype   // args, ptr__, ftype   */
// expects a 4byte value
            // 00000111000000000000000000000000 mask
            0x7000000
            and
            0x18
            shr
...
for_stack_16:
    ...
    forloop_end_stack_16:
        ...
        apply_stored_x1_extra:     // args, signature uint256 lookup in storage or forward to registered contract
            ...
            jump
        apply_stored_x1_extra_1:
            // args, sig_ptr__, tag, lambda_ptr__
            swap1    // args, sig_ptr__, lambda_ptr__, tag
            0xc0
            mstore   // put back tag // args, sig_ptr__, lambda_ptr__

            swap1     // args, lambda_ptr__, sig_ptr__
            pop       // args, lambda_ptr__
...
0x60
            ...
            /* (6) getoutputptr // lambda_ptr, new_env_ptr, new_frame_ptr, output_ptr   // lambda_ptr, new_env_ptr, new_frame_ptr, output_ptr   */
0xa0
            add
            mload
...
0x40
            ...
            /* (4) setdataptr // new_frame_ptr   // new_frame_ptr   */
0x20
            add
            mstore
...
// expects a 4byte value
            ...
            and
            0x07
            shr   // returns 0 (t1), 1 (t2), 2 (t3)
            gt
            apply_external_x1_extra_t2
            jumpi

            apply_external_x1_extra_end_t1
            0xc0
            mstore

            /* (1) getfunclength //  args, tag, code_ptr, length   //  args, tag, code_ptr, length   */
// expects a 4byte value
            0xfffc00
            and
            0x0a
            shr
            0x08
            add    // add apply sig length

            0x00
            0x00      // args, tag, code_ptr, length, 0x00, 0x00
            swap2      // args, tag, code_ptr, 0x00, 0x00, length
            swap1      // args, tag, code_ptr, 0x00, length, 0x00
            swap3     // args, tag, 0x00, 0x00, length, code_ptr
            0x00      // value
            /* (0) getleaf // leaf address   // leaf address   */
0x05
            sload
            gas
            call
...
// expects t2 pointer
    0x20
    add
            mload      // todo: proper processing of result - value, bytelike - what is it
            ...
            swap1
            pop
            // TODO: pop all args off the stack...
            // actually we should reconstruct the code from the results
            // not reexecute the entire code, that contains other functions too
        ...
        apply_external_x1_extra_t2:
            // args, tag, 4bsig
            apply_external_x1_extra_end_t2
            0xc0
            mstore

            /* (2) getfunclength //  args, tag, code_ptr, length   //  args, tag, code_ptr, length   */
// expects a 4byte value
            0xfffc00
            and
            0x0a
            shr
            0x10
            add    // add apply and return# sigs length

            // copy code and add a t2 return function before apply
            dup1               // args, sig_ptr__, tag, code_ptr, length, length
            /* (5) allocate 0x40    // args, sig_ptr__, tag, code_ptr, length, newcode_ptr_   // args, sig_ptr__, tag, code_ptr, length, newcode_ptr_   */
0x40    // args
    mload
    swap1
    dup2
    ...
    mstore
            ...
            0x3000900000000101000000000000000000000000000000000000000000000000
            dup2
            mstore    // add a return# function before apply

            // args, sig_ptr__, tag, code_ptr, length, newcode_ptr_
            0x08
            dup3   // args, sig_ptr__, tag, code_ptr, length, newcode_ptr_, 0x08, length
...
for_stack_18:
    ...
    forloop_end_stack_18:
        ...
        mmultimstore_end_8:
            ...
            // args, sig_ptr__, tag, code_ptr, length, newcode_ptr_
            swap2
            pop         // args, sig_ptr__, tag, newcode_ptr_, length

            0x00
            0x00      // args, sig_ptr__, tag, code_ptr, length, 0x00, 0x00
            swap2      // args, sig_ptr__, tag, code_ptr, 0x00, 0x00, length
            swap1      // args, sig_ptr__, tag, code_ptr, 0x00, length, 0x00
            swap3     // args, sig_ptr__, tag, 0x00, 0x00, length, code_ptr
            0x00      // value
            /* (1) getleaf // leaf address   // leaf address   */
0x05
            sload
            gas
            call
        ...
        apply_external_x1_extra_end_t2:
            ...
            swap1
            0xc0
            mstore   // args, sig_ptr__, result_ptr
...
for_stack_19:
        ...
        pop
        jump
    forloop_stack_19:   // any content variables are kept after jumptag, end, step
...
for_stack_20:
    ...
    forloop_end_stack_20:
        ...
        let_x1_extra:
            ...
            /* (26) t2_ptr_ // args_ptr__, computation_ptr_   // args_ptr__, computation_ptr_   */
// expects t2 pointer
    0x20
    add
            swap1         // computation_ptr_, args_ptr__
            /* (27) t2_ptr_ // computation_ptr_, args_ptr_   // computation_ptr_, args_ptr_   */
// expects t2 pointer
    0x20
    add
